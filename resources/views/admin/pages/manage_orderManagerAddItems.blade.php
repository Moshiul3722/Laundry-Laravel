        ...
        <form action="{{ route('add.items') }}" method="POST">
            ...
            <div class="ibox-content m-b-sm border-bottom">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="orderNo">Customer Address</label>
                            <input type="text" id="customerAddress" name="customerAddress" placeholder="Order Number"
                                value="{{ $result['customerAddress'] }}" readonly="readonly" class="form-control">
                        </div>
                    </div>
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-sm-12" id="addItemSection">
                                    ...
                                    <div class="row" id="add_item_detail_1">
                                        <div class="col-sm-2">
                                            <div class="form-group" style="position: relative">
                                        ...
                                        <div class="col-sm-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="price0" name="price[]" value="" placeholder="Price"
                                        ...
                                        <div class="col-sm-1">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="product_qty0" name="product_qty[]" min="0" value=""
                                                    placeholder="0" class="form-control" onchange="countPrice(0)">
                                            </div>
                                        </div>
                                        <div class="col-sm-1">
                                            <div class="form-group">
                                                <label class="col-form-label" for="totalPrice">Total Price</label>
                                                <input type="text" id="totalPrice0" name="totalPrice[]" value=""
                                                    placeholder="T.Price" class="form-control" readonly="readonly">
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control m-b large-bootstrap-select" name="vendorName[]"
                                                    id="vendorName0">
                                                    <option value="0" selected disabled>--- Select Vendor ---</option>
                                                    @foreach ($vendors as $vendor)
                                                        <option value="{{ $vendor->id }}">{{ $vendor->ven_name }};
                                        ...
                                        <div class="col-sm-1">
                                            <div class="form-group">
                                                ...
                                                <button type="button" id="btn-add-more-items"
                                                    ...
                                                    onclick="add_more_item()"><i class="fa fa-plus-circle"></i></button>
                                            </div>
                                        </div>
                                    </div>
            ...
            required="required">View Order List</a> --}}
                                    ...
                                    <div class="form-group">
                                        <button type="submit" id="addOrderDetails" class="btn btn-info btn-outline"
                                            required="required">Save Order</button>&nbsp;
                                        {{-- <button type="button" id="addOrderDetails"
                                            class="btn btn-success btn-outline float-right" required="required">Proceed to
                                            Payment</button> --}}
                                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        document.getElementById("timepkr2").value = strTime;
        ...
        function add_more_item() {
            ...
            html +=
                '<div class="col-sm-1"><div class="form-group"><label class="col-form-label" for="product_qty">Qty</label><input onchange="countPrice(loop_count)" type="number" id=product_qty' +
            ...
            if (id) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        let x =parseInt(response[0].price);
                        $(priceId).val(x.toFixed(2));
                        $(productQtyId).val('');
                        $(totalPriceId).val('');
                    }
                });
        ...
        function countPrice(counter) {
            ...
            $(totalPriceId).val(totalPrice.toFixed(2));
        }
        ...
        // function remove_more_item(loop_count) {
        //     jQuery('#manage_items_' + loop_count).remove();
        // }
    </script>
@endsection

    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <form action="{{ url('editItemOrder/' . '1') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group" style="position: relative">
                            ...
                            <select name="selectStaff" class="form-control" id="selectStaff" disabled>
                                <option value="0" selected>--- Select Delivery Person ---</option>
                                ...
                                @foreach ($staffInfo as $key => $list)
                                    ...
                                    @if ($result['staff_id'] == $strToArrList['id'])
                                        <option value="{{ $strToArrList['id'] }}" selected>
                                            {{ $strToArrList['staff_name'] }}</option>
                                    @else
                                        <option value="{{ $strToArrList['id'] }}">{{ $strToArrList['staff_name'] }}
                                        </option>
                                    @endif
                                @endforeach
                            </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div style="">
                                        <input id="timepkr2" name="timepkr2" style="width:100px;float:left;"
                                            class="form-control" placeholder="HH:MM"
                                            value="{{ $result['delivery_time'] }}" readonly="readonly" />
                                ...
                                <div class="col-sm-12" id="addItemSection">
                                    ...
                                    @foreach ($orderItems as $key => $val)
                                        ...
                                        <div class="row" id="add_item_detail_{{ $loop_count_num++ }}">
                                            ...
                                            <div class="col-sm-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="price0" name="price[]"
                                                        value="{{ number_format($items['price'], 2) }}"
                                            ...
                                            <div class="col-sm-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="totalPrice0" name="totalPrice[]"
                                                        value="{{ number_format($totalPrice, 2) }}" placeholder="T.Price"
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control m-b large-bootstrap-select"
                                                        name="vendorName[]" id="vendorName0" disabled>
                                            ...
                                            <div class="col-sm-1" id="loadContent">
                                                <div class="form-group">
                                                    <label class="col-form-label text-white btn-label-order-add-more"
                                                        for="price">AM</label>
                                                    @if ($items['item_process'] == 0)
                                                        <button type="button" id="btn-inProcess" class="btn btn-warning"
                                                            data-id="{{ $items['order_id'] }}">In Process</button>
                                                    @else
                                                        <button type="button" id="btn-itemComplete"
                                                            data-id="{{ $items['order_id'] }}" class="btn btn-info">
                                                            Complete</button>
                                                    @endif
            ...
            required="required">View Order List</a> --}}
                                    ...
                                    {{-- <div class="form-group">
                                        <button type="submit" id="addOrderDetails" class="btn btn-info btn-outline">Edit
                                            Items</button>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            //inprocess-Complete
            $(document).on('click', '#btn-inProcess', function() {
                // alert('active-' + $(this).data('id'));
                $.ajax({
                    url: "{{ url('itemInProcess') }}",
                    type: "post",
                    dataType: 'json',
                    data: {
                        "_token": "{{ csrf_token() }}",
            ...
            $(document).on('click', '#btn-itemComplete', function() {
                // alert('active-' + $(this).data('id'));
                $.ajax({
                    url: "{{ url('itemComplete') }}",
                    type: "post",
                    dataType: 'json',
                    data: {
                        "_token": "{{ csrf_token() }}",
